...
;Replace your Device with whatever what you have.
^Volume_Down:: SetDefaultEndpoint( GetDeviceID(Devices, "Headphones (High Definition Audio Device)") )
^Volume_Up:: SetDefaultEndpoint( GetDeviceID(Devices, "Dell S2721HN (NVIDIA High Definition Audio)") )
